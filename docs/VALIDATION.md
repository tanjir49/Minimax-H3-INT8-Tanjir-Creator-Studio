...
- The clean account opened Image, Video, Voice, and Music controls in Chrome; screenshots were captured for owner review.
...
Testing used the installed Python runtime and pinned package versions. A fresh pip installation and full GPU generation across all presets have not been verified. Third-party nodes/models/runtimes are external prerequisites. Screenshots and publication are pending owner approval.
