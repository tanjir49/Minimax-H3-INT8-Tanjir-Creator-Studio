...
- The optional model downloader passed PowerShell syntax validation. MiniMax H3 and original Wan 2.2 upstream URLs were checked without downloading model weights.
